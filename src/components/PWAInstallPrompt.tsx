      ...
      <AnimatePresence>
        {showPrompt && (
          <motion.div
            ...
            className="fixed top-0 left-0 right-0 z-50 mikropix-glass-effect border-b border-gray-800/50 md:hidden"
          >
            <div className="p-4">
      ...
      <AnimatePresence>
        {showPrompt && (
          ...
          >
            ...
            >
              <div className="bg-black/90 border border-gray-800/50 rounded-2xl p-8 max-w-md w-full backdrop-blur-sm">
                {/* Header */}
